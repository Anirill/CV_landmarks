    ...
    def __init__(self, root, transforms, split="train"):
        ...
        with open(landmark_file_name, "rt") as fp:
            for i, line in tqdm.tqdm(enumerate(fp), total=num_lines + 1):
                ...
                # for val in the beginning

                if split == "train" and i <= int((1 - TRAIN_SIZE) * num_lines):
                    continue  # reached end of train part of data
                elif split == "val" and i > int((1 - TRAIN_SIZE) * num_lines):
                    break  # has not reached start of val part of data
                # for val in the end
